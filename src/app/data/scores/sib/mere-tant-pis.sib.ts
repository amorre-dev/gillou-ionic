...
const MereTantPisSib = (): SheetData => {
  ...
  const note3_m2 = new StaveNote({ keys: ['b/4'], duration: '16' });
  const note4_m2 = new StaveNote({ keys: ['c/5'], duration: '8' });
  const note5_m2 = new StaveNote({ keys: ['a/4'], duration: '16' });
  const note6_m2 = new StaveNote({ keys: ['b/4'], duration: '16' });
