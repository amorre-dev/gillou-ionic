...
const TrompetteDesCentGardesSib = (): SheetData => {
  ...
  const measures: Measure[] = [
    { notes: [note1_m1, note2_m1, note3_m1], beams: [beam1_m1], weight: 4.5 },
    {
      notes: [
        note1_m2,
        note2_m2,
    ...
    { notes: [note1_m3, note2_m3, note3_m3], beams: [beam1_m3], weight: 3 },
  ];
...
export default TrompetteDesCentGardesSib;
