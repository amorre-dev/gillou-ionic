...
const DoudouSib = (): SheetData => {
  ...
  const note2_m3 = new StaveNote({ keys: ['f/4'], duration: '8' });
  const note3_m3 = new StaveNote({ keys: ['f/4'], duration: 'q' });
  const note4_m3 = new StaveNote({ keys: ['b/4'], duration: '8r' });

  const measures: Measure[] = [
    { notes: [note1_m1, note2_m1, note3_m1], weight: 3 },
    { notes: [note1_m2, note2_m2, note3_m2, note4_m2], weight: 5 },
    { notes: [note1_m3, note2_m3, note3_m3, note4_m3], weight: 3.5 },
  ];
