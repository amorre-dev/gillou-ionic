...
const ChasseursSib = (): SheetData => {
  const note1_m1 = dotted(new StaveNote({ keys: ['b/4'], duration: 'qdr' }));
  const note2_m1 = new StaveNote({ keys: ['c/5'], duration: '8' });
  ...
  const note1_m3 = new StaveNote({ keys: ['e/4'], duration: '16' });
  const note2_m3 = new StaveNote({ keys: ['f/4'], duration: '16' });
  const note3_m3 = new StaveNote({ keys: ['g/4'], duration: '16' });
  const note4_m3 = new StaveNote({ keys: ['a/4'], duration: '16' });
  ...
  const measures: Measure[] = [
    { notes: [note1_m1, note2_m1], weight: 5 },
    {
